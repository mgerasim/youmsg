...
class ProtocolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create protocol" do
    assert_difference('Protocol.count') do
      post protocols_url, params: { protocol: { activate_id: @protocol.activate_id, msg: @protocol.msg } }
    end
  ...
  test "should update protocol" do
    patch protocol_url(@protocol), params: { protocol: { activate_id: @protocol.activate_id, msg: @protocol.msg } }
